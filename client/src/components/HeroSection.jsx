      ...
      <div className="relative h-full flex items-end md:items-center px-4 md:px-12 lg:px-16 pb-24 md:pb-32">
        <div className="max-w-2xl space-y-4 md:space-y-6">
          ...
          <div className="flex space-x-3 md:space-x-4 pt-2">
            {/* Play Button */}
            <button className="flex items-center space-x-2 bg-white text-black px-6 md:px-8 py-2 md:py-3 rounded font-semibold hover:bg-opacity-80 transition-all transform hover:scale-105">
              <svg
            ...
            {/* More Info Button */}
            <button className="flex items-center space-x-2 bg-gray-500 bg-opacity-70 text-white px-6 md:px-8 py-2 md:py-3 rounded font-semibold hover:bg-opacity-50 transition-all">
              <svg
                className="w-5 h-5 md:w-6 md:h-6"
                fill="none"
                stroke="currentColor"
